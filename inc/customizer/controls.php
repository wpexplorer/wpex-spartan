...
// Return if WP_Customize_Control doesn't exist
if ( ! class_exists( 'WP_Customize_Control' ) ) {
	return NULL;
}

function wpex_add_customizer_custom_controls( $wp_customize ) {
	 ...
	 * @since Spartan 1.0.2
	 */
	if ( ! class_exists( 'WPEX_Text_Editor_Control' ) ) {
	 ...
	 * @since Spartan 1.0.2
	 */
	if ( ! class_exists( 'WPEX_Category_Dropdown_Custom_Control' ) ) {
		class WPEX_Category_Dropdown_Custom_Control extends WP_Customize_Control {
			public function render_content() {
			$dropdown = wp_dropdown_categories(
				array(
					'name'				=> '_customize-dropdown-cats-' . $this->id,
					'echo'				=> 0,
					'show_option_none'	=> __( '&mdash; Select &mdash;', 'spartan' ),
					'selected'			=> $this->value(),
	 ...
	 * @since Spartan 1.0.2
	 */
	if ( ! class_exists( 'WPEX_Customize_Sliderui_Control' ) ) {
		...
		class WPEX_Fonts_Dropdown_Custom_Control extends WP_Customize_Control {
			...
			<label>
				<span class="customize-control-title"><?php echo esc_html( $this->label ); ?></span>
					...
					<option value="" <?php if( ! $this_val ) echo 'selected="selected"'; ?>><?php _e( 'Default', 'spartan' ); ?></option>
					<?php
					...
					<option value="Courier, monospace" <?php if( "Courier, monospace" == $this_val ) echo 'selected="selected"'; ?>>Courier, monospace</option>
					<option value="Arial Black" <?php if( "Arial Black" == $this_val ) echo 'selected="selected"'; ?>>Arial Black</option>
					<option value="Arial" <?php if( "Arial" == $this_val ) echo 'selected="selected"'; ?>>Arial</option>
					...
					<option value="Times New Roman" <?php if( "Times New Roman" == $this_val ) echo 'selected="selected"'; ?>>Times New Roman</option>
					<option value="Times New Roman, Times,serif" <?php if( "Times New Roman, Times,serif" == $this_val ) echo 'selected="selected"'; ?>>Times New Roman, Times,serif</option>
...
add_action( 'customize_register', 'wpex_add_customizer_custom_controls' );